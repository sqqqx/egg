...
<head>
    <meta charset="UTF-8"><link rel="stylesheet" href="/resources/css/admin/memberManagement.css">
    <title>회원 관리</title>
</head>
...
<body>
    <%@include file="/WEB-INF/views/header.jsp" %>
        <div class="main-Wrapper d-flex justify-content-center pt-5">
            ...
            <div class="cls-main">
                <!-- 검색 영역 -->
                <form id="searchForm" action="${pageContext.request.contextPath}/admin/getMemberList.do?currentIdx=1"
