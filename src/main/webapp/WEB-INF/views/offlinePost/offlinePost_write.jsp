    ...
    <div class="container">
        ...
        <form action="/offlinePost/insertPost.do" method="post" id="writeForm">
            <div class="accordion" id="accordionExample">
                ...
                <div class="buttonss">
                    <button type="button" class="btn btn-warning btns" id="submitBtn">1:1 고수 찾기</button>
                    <button type="button" class="btn btn-secondary btns" id="cancel">취소</button>
                </div>
        </form>
    </div>
    <script>
        ...
        function submitForm() { //제목과 내용 형식 맞추기
           ...
           /*  if(reservation_time=="undefined"){
            ...
            var content = "<h4 style='font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(33, 37, 41); text-align: left;'><span style='font-weight: 700;'>1. 어떤 분야의 도움이 필요하신가요?</span></h4><h4 style='font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(33, 37, 41); text-align: left;'>:&nbsp; " + category_text + "</h4><p style='text-align: left;'><br></p>\
                 ...
                 <h4 style='font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(33, 37, 41); text-align: left;'><span style='font-weight: 700;'>5. 원하는 날짜가 있나요?</span></h4><h4 style='font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(33, 37, 41); text-align: left;'>:&nbsp;"+ class_time +"<br>"+ reservation_time +"</h4><p style='text-align: left;'><br></p>\
                 <h4 style='font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(33, 37, 41); text-align: left;'><span style='font-weight: 700;'>6. 수업 관련 희망사항이 있나요?</span></h4><h4 style='font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; color: rgb(33, 37, 41); text-align: left;'>:&nbsp; "+ wish + "</h4>";
